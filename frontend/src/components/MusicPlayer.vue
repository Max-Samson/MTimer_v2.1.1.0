...
import { Music, Pause, Play, SkipBack, SkipForward, VolumeDown, VolumeMute, VolumeUp } from '@vicons/carbon'
import { NButton, NCard, NIcon, NList, NListItem, NSlider, NSpace, NText } from 'naive-ui'
        ...
        try {
          ...
          audio.onloadeddata = (event) => {
            ...
            if (originalOnloadeddata)
              originalOnloadeddata.call(audio, event)
          }
...
<template>
  <div class="music-player">
    <NCard class="player-card" :bordered="false">
      <!-- 播放器主界面 -->
      <div class="player-main">
        ...
        <div class="album-cover-container">
          <div class="album-cover" :class="{ rotating: soundSettings.bgMusic.isPlaying }">
            <div class="cover-inner">
              <NIcon size="48" color="#ffffff">
                <Music />
              </NIcon>
            </div>
          </div>
          <div class="album-reflection" />
          <div v-if="soundSettings.bgMusic.isPlaying" class="play-indicator" />
        </div>
        ...
        <div class="player-controls">
          ...
          <div class="progress-container">
            <NSlider v-model:value="progress" :step="0.1" @update:value="setProgress" />
          ...
          <div class="control-buttons">
            <NSpace justify="center">
              <NButton circle secondary @click="playPrevious">
                <template #icon>
                  <NIcon>
                    <SkipBack />
                  </NIcon>
              ...
              <NButton circle type="primary" @click="togglePlay">
                <template #icon>
                  <NIcon>
              ...
              <NButton circle secondary @click="playNext">
                <template #icon>
                  <NIcon>
                    <SkipForward />
                  </NIcon>
              ...
              <div class="volume-control">
                <NButton circle secondary class="volume-btn">
                  <template #icon>
                    <NIcon>
                ...
                <div class="volume-slider-container">
                  <NSlider
                    v-model:value="soundSettings.bgMusic.volume" :step="0.01" :min="0"
                    :max="1" style="width: 80px"
                    @update:value="(val) => settingsStore.setBgMusicVolume(val)"
                  />
                  <div class="volume-value">
                    {{ Math.round(soundSettings.bgMusic.volume * 100) }}%
                  </div>
                </div>
              </div>
            </NSpace>
      ...
      <div class="playlist-container">
        <NText class="playlist-title">
          播放列表
        </NText>
        <NList hoverable clickable>
          <NListItem
            v-for="track in soundSettings.bgMusic.playlist" :key="track.value"
          ...
          >
            <NSpace justify="space-between" align="center" style="width: 100%">
              <NText>{{ track.label }}</NText>
              <NIcon
                v-if="track.value === soundSettings.bgMusic.currentTrack" size="16"
