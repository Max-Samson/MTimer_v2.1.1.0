...
import { CheckmarkDone, TimeOutline, Timer } from '@vicons/ionicons5'
...
<template>
  <div class="daily-summary">
    ...
    <div v-else-if="!hasSummaryData" class="empty-container">
      <NEmpty description="暂无专注数据" size="small">
    ...
    <div v-else class="summary-content">
      <div class="summary-item">
        <div class="item-count">
          {{ summary.todayCompletedPomodoros || 0 }}
        </div>
        <div class="item-title">
          <NIcon class="item-icon tomato">
            <Timer />
          </NIcon>
          <span>完成番茄</span>
        </div>
      ...
      <div class="summary-item">
        <div class="item-count">
          {{ summary.todayCompletedTasks || 0 }}
        </div>
        <div class="item-title">
          <NIcon class="item-icon task">
            <CheckmarkDone />
          </NIcon>
          <span>完成任务</span>
        </div>
